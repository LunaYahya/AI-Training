...
downloaded directly from Kaggle,this dataset contains various numerical and categorical features related to student demographics, study habits, and academic performance.
## Hands-On Lab (Tasks)
